...
$modules[$i]["name"] = "阿里大鱼";
$modules[$i]["val"] = array('AlidayuSmsSgin'=>'短信签名','AlidayuAppKey'=>'AppKey','AlidayuAppSecret'=>'AppSecret');
...
class Alidayu{
	...
	public function send($mobile,$tplCode,$smsParams = array()){	
        ...
        $params["SignName"] = $this->AlidayuSmsSgin; 
        if($tplCode == 'SMS_174985130'){
            $params["SignName"] = '湖北李时珍'; 
        }
   ...
   //     print_r($params);
   //     echo $accessKeyId.'--'.$accessKeySecret;
