...
class miniAppPay
{
    ...
    public function  __construct($code=""){
        ...
        \WxPayConfig::$appid = $this->setting['xcx_appid']; // * APPID：绑定支付的APPID（必须配置，开户邮件中可查看）
        \WxPayConfig::$mchid = $this->setting['xcx_mchid']; // * MCHID：商户号（必须配置，开户邮件中可查看）
        \WxPayConfig::$key = $this->setting['xcx_mchid_key']; // KEY：商户支付密钥，参考开户邮件设置（必须配置，登录商户平台自行设置）
        \WxPayConfig::$appsecret = $this->setting['xcx_appsecret']; // 公众帐号secert（仅JSAPI支付的时候需要配置)，
