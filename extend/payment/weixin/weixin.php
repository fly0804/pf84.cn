...
class weixin
{
    ...
    {
		$go_url = SITE_URL.'/shop/order/success';
		$back_url = url('shop/tuan/info',array('tuan_id'=>session('tuan_id')));
        $callback_url = SITE_URL.'/shop/payment/notifyUrl/pay_code/weixin';
        trace($callback_url,'debug');
        //①、获取用户openid
        $tools = new \JsApiPay();
