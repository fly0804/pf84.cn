...
var provinceList = [
    ...
    {
        name: '天津市', cityList: [
            { name: '市辖区', areaList: ['和平区', '河东区', '河西区', '南开区', '河北区', '红桥区', '塘沽区', '汉沽区', '大港区', '东丽区', '西青区', '津南区', '北辰区', '武清区', '宝坻区', '滨海新区', '宁河区', '静海区', '蓟州区', '滨海高新区'] },
    ...
    {
        name: '贵州省', cityList: [
            { name: '贵阳市', areaList: ['市辖区', '南明区', '云岩区', '花溪区', '乌当区', '白云区', '观山湖区','贵安新区','高新区','小河区', '开阳县', '息烽县', '修文县', '清镇市'] },
    ...
    },
    {
        name: '云南省', cityList: [
            ...
            { name: '德宏傣族景颇族自治州', areaList: ['瑞丽市', '潞西市', '梁河县', '盈江县', '陇川县', '芒市'] },
    ...
    },
    {
        name: '广东省', cityList: [
            ...
            { name: '深圳市', areaList: ['市辖区', '罗湖区', '福田区', '南山区', '宝安区', '龙岗区', '盐田区', '龙华区', '坪山区', '光明新区', '大鹏新区'] },
            ...
            { name: '东莞市', areaList: ['莞城街道', '东城街道', '南城街道', '万江街道', '石碣镇', '高埗镇', '麻涌镇', '洪梅镇', '中堂镇', '望牛墩镇', '道滘镇', '虎门镇', '长安镇', '厚街镇', '沙田镇', '滨海湾新区', '石龙镇', '石排镇', '茶山镇', '寮步镇', '大岭山镇', '大朗镇', '松山湖高新区', '常平镇', '黄江镇', '企石镇', '桥头镇', '横沥镇', '谢岗镇', '东部工业园', '塘厦镇', '清溪镇', '樟木头镇', '凤岗镇'] },
            { name: '中山市', areaList: ['石岐区','东区','西区','南区','五桂山','火炬开发区','黄圃镇', '南头镇', '东凤镇', '阜沙镇', '小榄镇', '东升镇', '古镇镇', '横栏镇', '三角镇', '民众镇', '南朗镇', '港口镇', '大涌镇', '沙溪镇', '三乡镇', '板芙镇', '神湾镇', '坦洲镇'] },
    ...
    },
    {
        name: '新疆维吾尔自治区', cityList: [
            ...
            { name: '直辖行政单位', areaList: ['石河子市', '阿拉尔市', '图木舒克市', '五家渠市'] }
        ]
    },
    {
        name: '河北省', cityList: [
