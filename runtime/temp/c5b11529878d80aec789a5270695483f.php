<?php /*a:3:{s:75:"D:\NMP\www\mypro\jinmoshu\code\application\mainadmin\view\module\index.html";i:1574469805;s:75:"D:\NMP\www\mypro\jinmoshu\code\application\mainadmin\view\layouts\base.html";i:1570862470;s:75:"D:\NMP\www\mypro\jinmoshu\code\application\mainadmin\view\layouts\page.html";i:1562570022;}*/ ?>
...
<section class="scrollable  wrapper">
    <section class="panel panel-default">
        <header class="panel-heading">
            <a href="javascript:;" data-remote="<?php echo url('info'); ?>" data-toggle="ajaxModal" class="btn btn-sm btn-default"><i class="fa fa-plus m-r-xs"></i>添加模块</a>
                    ...
                    <?php if(is_array($list[0]) || $list[0] instanceof \think\Collection || $list[0] instanceof \think\Paginator): $i = 0; $__LIST__ = $list[0];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <li class="dd-item" data-id="<?php echo htmlentities($vo['id']); ?>">
                            <div class="dd-handle">
                                ...
                                <span style="padding-left:50px;"><?php echo htmlentities($vo['formula']); ?></span>
                                <span class="pull-right">
                                    ...
                                    <a href="<?php echo url('del',array('id'=>$vo['id'])); ?>" data-toggle="ajaxRemove" data-msg="确定删除  <?php echo htmlentities($vo['name']); ?>模块 ?"><i class="fa fa-trash-o icon-muted fa-fw"></i></a>
                                </span>
                            </div>
        ...
        <footer class="panel-footer">
            <button type="submit" class="btn btn-primary" data-loading-text="保存中..." data-remote="<?php echo url('saveSort'); ?>" id="save_class">保存排序</button>
            <button type="submit"  class="btn btn-primary" data-loading-text="导出中..." data-remote="<?php echo url('exeTactics'); ?>" id="exe_class">生成策略</button>
...
<script type="text/javascript">
    ...
    $(function (){
      $("#exe_class").click(function (){
        window.location.href = "<?php echo url('exeTactics'); ?>";
      })
    })
</script>
