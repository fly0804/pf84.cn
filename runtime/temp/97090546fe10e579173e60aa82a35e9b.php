<?php /*a:4:{s:79:"D:\NMP\www\mypro\jinmoshu\code\application\mainadmin\view\admin_user\index.html";i:1568766130;s:75:"D:\NMP\www\mypro\jinmoshu\code\application\mainadmin\view\layouts\base.html";i:1570862470;s:78:"D:\NMP\www\mypro\jinmoshu\code\application\mainadmin\view\admin_user\list.html";i:1569374102;s:75:"D:\NMP\www\mypro\jinmoshu\code\application\mainadmin\view\layouts\page.html";i:1562570022;}*/ ?>
...
<header class="header  b-b clearfix">
    <form id="forms" class="talbe-search form-inline "  method="post" action="<?php echo url('getList'); ?>" >
     <div class="page-breadcrumbs">
            ...
            <select name="role_id"  style="width: 200px;" data-toggle="select2" data-placeholder="按自定义筛选" data-chang="submit">
              ...
              <a href="<?php echo url('info'); ?>"  title="添加管理员" class="btn btn-sm btn-default fr m-t-md m-r"><i class="fa fa-plus m-r-xs"></i>添加管理员</a>
        </div>
    </form>
</header>
...
<tr>
    ...
    <th width="120">最近登陆</th>
    <th width="120">最近IP</th>
    <th width="90">开团数</th>
    <th width="60">状态</th>
    <th width="80">操作</th>
</tr>
...
<tr>
    ...
    <td><?php echo htmlentities(adminRole($vo['role_id'])); ?></td>
    <td><?php echo htmlentities($vo['real_name']); ?></td>
    <td><?php echo htmlentities($vo['moblie']); ?></td>
   ...
   <td><a href="javascript:;"  class="<?php echo htmlentities(tplckval($vo['status'],'=1','active')); ?>"><i class="fa fa-check text-success text-active"></i><i class="fa fa-times text-danger text"></i></a></td>
	<td>
<a href="<?php echo url('mainadmin/log.login/index',['user_id'=>$vo['user_id']]); ?>" title="查看登陆日志" class="fa fa-search text-muted m-xs"></a>
<a href="<?php echo url('info',['user_id'=>$vo['user_id']]); ?>" title="编辑" class="fa fa-edit text-muted m-xs" ></a>
