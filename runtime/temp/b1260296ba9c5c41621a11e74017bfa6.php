<?php /*a:3:{s:67:"D:\NMP\www\mypro\pf84\application\mainadmin\view\sms_fun\index.html";i:1562570030;s:66:"D:\NMP\www\mypro\pf84\application\mainadmin\view\layouts\base.html";i:1576477878;s:66:"D:\NMP\www\mypro\pf84\application\mainadmin\view\layouts\page.html";i:1562570022;}*/ ?>
                    ...
                    <div class="collapse in">
                        <form class="form-horizontal form-validate" method="post" action="<?php echo url('save'); ?>">
                            ...
                            <div class="form-group">
                                  ...
                                  <div class="col-sm-5 must">
                                    <select  id="supplier" class="input-max" data-rule-required="true" name="supplier">
                                         ...
                                         <?php if(is_array($function) || $function instanceof \think\Collection || $function instanceof \think\Paginator): $i = 0; $__LIST__ = $function;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>	
                                            <option value="<?php echo htmlentities($val['function']); ?>" <?php echo $row['function']==$val['function'] ? 'selected' : ''; ?> data-jsonval='<?php echo htmlentities(json_encode($val['val'])); ?>'><?php echo htmlentities($val['name']); ?></option>            
                                         <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                             </div>
                             <div id="function_val_box">
                             <?php if(is_array($row['function_val']) || $row['function_val'] instanceof \think\Collection || $row['function_val'] instanceof \think\Paginator): $i = 0; $__LIST__ = $row['function_val'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
                                <div class="form-group">
                                    <label class="control-label"><?php echo htmlentities($function[$row["function"]][val][$key]); ?>：</label>
                                    <div class="col-sm-5 ">
                                       <input type="text" name="function_val[<?php echo htmlentities($key); ?>]"  class="input-max" data-rule-required="true" value="<?php echo htmlentities($val); ?>">
                                  </div>
                               </div>
                             <?php endforeach; endif; else: echo "" ;endif; ?>
                             </div>
                               <div class="form-group">
                                  <label class="control-label">用户注册时：</label>
                                    <div class="col-sm-4 m-t-md">
                                         <label class="fl">
                                               <input class="checkbox-slider colored-blue rand_amount"  name="register"  type="checkbox" value="1" <?php echo htmlentities(tplckval($row['register'],1,'checked')); ?>>
                              ...
                              <!-- <div class="form-group">
                                  <label class="control-label">用户登陆时：</label>
                                    <div class="col-sm-4 m-t-md">
                                         <label class="fl">
                                               <input class="checkbox-slider colored-blue rand_amount"  name="login"  type="checkbox" value="1" <?php echo htmlentities(tplckval($row['login'],1,'checked')); ?>>
                                               <span class="text"></span>
                                         </label>
                             ...
                             <div class="form-group">
                                  <label class="control-label">找回密码时：</label>
                                    <div class="col-sm-4 m-t-md">
                                         <label class="fl">
                                               <input class="checkbox-slider colored-blue rand_amount"  name="forget_password" type="checkbox" value="1" <?php echo htmlentities(tplckval($row['forget_password'],1,'checked')); ?>>
                                               <span class="text"></span>
                                         </label>
                            ...
                            <!-- <div class="form-group">
                                ...
                                <div class="col-sm-4 m-t-md">
                                    <label class="fl">
                                        <input class="checkbox-slider colored-blue rand_amount"  name="bind_mobile" type="checkbox" value="1" <?php echo htmlentities(tplckval($row['bind_mobile'],1,'checked')); ?>>
                                        <span class="text"></span>
                                    </label>
                                    <span class="fl">用户找回密码时使用短信验证</span>
                                </div>
                             ...
                             <!-- <div class="form-group">
                                  <label class="control-label">商家发货时：</label>
                                    <div class="col-sm-4 m-t-md">
                                         <label class="fl">
                                               <input class="checkbox-slider colored-blue rand_amount"  name="shipping" type="checkbox" value="1" <?php echo htmlentities(tplckval($row['shipping'],1,'checked')); ?>>
                                               <span class="text"></span>
                                         </label>
                             ...
                             <div class="form-group">
                                  <label class="control-label">后台登陆时：</label>
                                    <div class="col-sm-4 m-t-md">
                                         <label class="fl">
                                               <input class="checkbox-slider colored-blue rand_amount"  name="admin_login" type="checkbox" value="1" <?php echo htmlentities(tplckval($row['admin_login'],1,'checked')); ?>>
                                               <span class="text"></span>
                                         </label>
                             ...
                             <div class="form-group">
                                  <label class="control-label">满5万销售额时：</label>
                                    <div class="col-sm-4 m-t-md">
                                         <label class="fl">
                                               <input class="checkbox-slider colored-blue rand_amount"  name="shipping" type="checkbox" value="1" <?php echo htmlentities(tplckval($row['shipping'],1,'checked')); ?>>
                                               <span class="text"></span>
                                         </label>
                                         <span class="fl">是否给客户发短信</span>
                                    </div>
                             </div>
                             <div class="form-group">
